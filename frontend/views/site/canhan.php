...
?>
    ...
    <div class="col-xs-12"style="text-align: center; color: #3c763d ;font-size: 26px;font-weight: bold ;padding-bottom: 25px">
    ...
    <div class="container">
        ...
        <?=generateHtml("Các vùng dịch đã đên",($model->yeutodichte_quocgiadiadiem==""||$model->yeutodichte_quocgiadiadiem==", Các vùng dịch: ")?"Không":$model->yeutodichte_quocgiadiadiem)?>
        <?=generateHtml("Khai báo tại",($model->donvi==0 ||$model->donvi==-1)?"Website Sở Y Tế":(\common\models\Benhvien::find()->where(['id'=>$model->donvi])->one())->name)?>
    </div>
    <div class="container">
    ...
    <script>
        ...
        <div class="clearfix" style="text-align: center;margin: 20px auto"> <a href="/" class="btn btn-success">Khai báo khác</a></div>
