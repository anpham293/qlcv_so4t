...
/* @var $searchModel common\models\search\BaocaocongviecSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Báo cáo công việc';
$this->params['breadcrumbs'][] = ['name'=>$this->title,'link'=>'javascript:void(0)'];

CrudAsset::register($this);

?>
<div class="baocaocongviec-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm báo cáo','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Báo cáo công việc',
