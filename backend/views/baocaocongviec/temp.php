...
<table class="table table-striped table-hover table-bordered">
    <tr><th  colspan="8" style="background: #f6ffad">Báo cáo tiến độ thực hiện <a class="btn btn-default" style="float: right" href="/admin/baocaocongviec/create?ids=<?=$model->id?>" title="Tạo mới báo cáo" role="modal-remote"><i class="glyphicon glyphicon-plus"></i> Thêm báo cáo</a></th></tr>
    <tbody style="max-height: 250px;overflow:scroll; width: 100%;">
    <?php if(empty($model->baocaocongviecs)):?>
        <tr><td colspan="4">Chưa có báo cáo nào</td></tr>
    <?php else:?>
