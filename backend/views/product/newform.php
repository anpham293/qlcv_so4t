                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4 hidden">
                            <?= $form->field($model, 'status')->dropDownList(['1' => 'Instock', '0' => 'Out of stock',], []) ?>
                        </div>
                        <div class="col-xs-4">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-md-3">
                            <div class="form-group has-error">
                                ...
                                <?php echo Html::dropDownList('Product[kieudangky]', '', \yii\helpers\ArrayHelper::map(
                                    [
                                        ['id' => '1', 'name' => 'Gọi điện'],
                                        ['id' => '2', 'name' => 'Nhắn tin'],
                        ...
                        <div class="col-xs-6 col-md-3">
                            <div class="form-group has-error">
                                ...
                                <?php echo Html::textInput('Product[cuphap]', \common\models\Configure::getConfig()['contact_hotline'], ['class' => 'form-control', 'id' => 'cuphap']) ?>
                            </div>
                        </div>
                        <div class="col-xs-6 col-md-3">
