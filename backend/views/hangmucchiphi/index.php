...
/* @var $searchModel common\models\search\HangmucchiphiSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Hạng mục chi phí';
$this->params['breadcrumbs'][] = ['name'=>$this->title,'link'=>'javascript:void(0)'];

CrudAsset::register($this);

?>
<div class="hangmucchiphi-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới hạng mục chi phí','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Hạng mục chi phí',
