...
/* @var $searchModel common\models\search\KetoanduanSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Ketoanduans';
$this->params['breadcrumbs'][] = ['name'=>$this->title,'link'=>'javascript:void(0)'];

CrudAsset::register($this);

?>
<div class="ketoanduan-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới kế toán dự án','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> kế toán dự án',
